...
const QuickConnectWizard: React.FC<QuickConnectWizardProps> = ({
  ...
  // Switch to manual tab: clear identity-prefilled credentials
  const switchToManual = () => {
    setCredentialSourceTab("manual");
    // Clear credentials that were auto-filled from identity selection
  ...
  // Switch to keychain tab: keep currently selected identity if any
  const switchToKeychain = () => {
    setCredentialSourceTab("keychain");
  };
