...
export function getLineTimestampToggleHostUpdate<T extends { id: string; showLineTimestamps?: boolean; [key: string]: any }>(
  host: T,
              ...
              <div className="text-center">
                <div className="text-lg font-semibold mb-2">
                  {isLocalConnection
                    ...
                    : isZmodemUploadMode
                      ? t("terminal.dragDrop.zmodemTitle")
                ...
                <div className="text-sm text-muted-foreground">
                  {isLocalConnection
                    ...
                    : isZmodemUploadMode
                      ? t("terminal.dragDrop.zmodemMessage")
