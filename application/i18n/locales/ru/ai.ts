...
export const ruAiMessages: Messages = {
  ...
  'ai.agents': 'Агенты',
  'ai.network.title': 'Сеть',
  'ai.network.description': 'Настройте отдельный HTTP-прокси только для AI-запросов, списка моделей, web search и управляемых агентов.',
  'ai.network.localOnly': 'Этот параметр хранится только на текущем устройстве и сразу применяется к следующим AI-запросам и следующим ходам агентов.',
  'ai.network.mode': 'HTTP-прокси',
  'ai.network.mode.description': 'Выберите: без прокси, системный прокси или собственный прокси для AI-трафика.',
  'ai.network.mode.off': 'Выключен',
  'ai.network.mode.system': 'Системный прокси',
  'ai.network.mode.custom': 'Свой прокси',
  'ai.network.scheme': 'Схема',
  'ai.network.scheme.description': 'Протокол подключения к прокси-серверу.',
  'ai.network.scheme.http': 'HTTP',
  'ai.network.scheme.https': 'HTTPS',
  'ai.network.host': 'Хост',
  'ai.network.host.description': 'Имя хоста или IP-адрес прокси-сервера.',
  'ai.network.host.placeholder': 'например proxy.example.com',
  'ai.network.port': 'Порт',
  'ai.network.port.description': 'Допустимый диапазон: 1-65535.',
  'ai.network.username': 'Имя пользователя',
  'ai.network.username.description': 'Необязательно. Используется только для аутентификации на прокси.',
  'ai.network.username.placeholder': 'Необязательно',
  'ai.network.password': 'Пароль',
  'ai.network.password.description': 'Сохраняется в зашифрованном виде на этом устройстве.',
  'ai.network.password.placeholder': 'Необязательно',
  'ai.network.validation.hostRequired': 'В режиме собственного прокси нужно указать хост.',
  'ai.network.validation.hostInvalid': 'Укажите корректный хост прокси без путей и пробелов.',
  'ai.network.validation.portInvalid': 'Введите порт от 1 до 65535.',
