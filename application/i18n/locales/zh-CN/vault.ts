...
export const zhCNVaultMessages: Messages = {
  ...
  'terminal.toolbar.zmodemUpload': 'Zmodem 上传模式',
  'terminal.toolbar.zmodemUploadOn': 'Zmodem 上传模式（已开启）',
  ...
  'terminal.dragDrop.zmodemTitle': '拖放以 Zmodem 上传',
  'terminal.dragDrop.zmodemMessage': '文件将通过 rz -E 命令上传到远端',
