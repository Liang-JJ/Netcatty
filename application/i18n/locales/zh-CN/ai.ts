...
export const zhCNAiMessages: Messages = {
  ...
  'ai.network.description': '为 AI 单独配置 HTTP 代理，覆盖 provider 请求、模型发现、Web Search 以及托管 Agent。',
  'ai.network.localOnly': '这是本机专属设置，不参与云同步；保存后会立即影响后续 AI 请求和后续 agent turn。',
  'ai.network.mode': 'HTTP 代理',
  'ai.network.mode.description': '选择 AI 流量关闭代理、跟随系统代理，或使用自定义代理。',
  'ai.network.mode.off': '关闭',
  'ai.network.mode.system': '系统代理',
  'ai.network.mode.custom': '自定义代理',
  'ai.network.scheme': '协议',
  'ai.network.scheme.description': '连接代理服务器时使用的协议。',
  'ai.network.scheme.http': 'HTTP',
  'ai.network.scheme.https': 'HTTPS',
  'ai.network.host': '主机',
  'ai.network.host.description': '代理服务器的主机名或 IP 地址。',
  'ai.network.host.placeholder': '例如 proxy.example.com',
  'ai.network.port': '端口',
  'ai.network.port.description': '有效范围：1-65535。',
  'ai.network.username': '用户名',
  'ai.network.username.description': '可选。仅在代理认证时发送。',
  'ai.network.username.placeholder': '可选',
  'ai.network.password': '密码',
  'ai.network.password.description': '会在当前设备上加密保存。',
  'ai.network.password.placeholder': '可选',
  'ai.network.validation.hostRequired': '自定义代理模式下必须填写主机。',
  'ai.network.validation.hostInvalid': '请输入有效的代理主机，不能包含路径或空格。',
  'ai.network.validation.portInvalid': '请输入 1 到 65535 之间的端口。',
