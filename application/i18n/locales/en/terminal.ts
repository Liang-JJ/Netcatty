...
export const enTerminalMessages: Messages = {
  ...
  'terminal.toolbar.zmodemUpload': 'Zmodem Upload Mode',
  'terminal.toolbar.zmodemUploadOn': 'Zmodem Upload Mode (On)',
  ...
  'terminal.dragDrop.zmodemTitle': 'Drop to Upload via Zmodem',
  'terminal.dragDrop.zmodemMessage': 'Files will be uploaded via rz -E command',
