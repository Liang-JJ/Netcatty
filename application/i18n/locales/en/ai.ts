...
export const enAiMessages: Messages = {
  ...
  'ai.agents': 'Agents',
  'ai.network.title': 'Network',
  'ai.network.description': 'Configure an AI-only HTTP proxy for provider requests, model discovery, web search, and managed agents.',
  'ai.network.localOnly': 'This setting is local to this device and applies immediately to subsequent AI requests and agent turns.',
  'ai.network.mode': 'HTTP Proxy',
  'ai.network.mode.description': 'Choose whether AI traffic bypasses proxies, follows the system proxy, or uses a custom proxy.',
  'ai.network.mode.off': 'Off',
  'ai.network.mode.system': 'System Proxy',
  'ai.network.mode.custom': 'Custom Proxy',
  'ai.network.scheme': 'Scheme',
  'ai.network.scheme.description': 'Protocol used to connect to the proxy server.',
  'ai.network.scheme.http': 'HTTP',
  'ai.network.scheme.https': 'HTTPS',
  'ai.network.host': 'Host',
  'ai.network.host.description': 'Hostname or IP address of the proxy server.',
  'ai.network.host.placeholder': 'e.g. proxy.example.com',
  'ai.network.port': 'Port',
  'ai.network.port.description': 'Valid range: 1-65535.',
  'ai.network.username': 'Username',
  'ai.network.username.description': 'Optional. Sent only for proxy authentication.',
  'ai.network.username.placeholder': 'Optional',
  'ai.network.password': 'Password',
  'ai.network.password.description': 'Stored encrypted on this device.',
  'ai.network.password.placeholder': 'Optional',
  'ai.network.validation.hostRequired': 'Host is required in custom proxy mode.',
  'ai.network.validation.hostInvalid': 'Enter a valid proxy host without paths or spaces.',
  'ai.network.validation.portInvalid': 'Enter a port between 1 and 65535.',
